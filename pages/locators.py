...
class AuthPageLocators:
    ...
    AUTH_ERROR_WRONG_LOGIN_OR_PASSWORD = (By.XPATH, "//span[contains(text(),'Неверный логин или пароль')]")
    ...
    AUTH_SOCIAL_GOOGLE_LINK = (By.XPATH, "//a[@id='oidc_google']")
...
class RegistrationPageLocators:
    ...
    REG_LOGO = (By.XPATH, "//section[@id='page-left']/*/div[@class='what-is-container__logo-container']/*")
    REG_SLOGAN = (By.XPATH,
                   "//section[@id='page-left']/*//p[contains(text(),'Персональный помощник в цифровом мире "
                   "Ростелекома')]")
